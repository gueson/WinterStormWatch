...
function AlertCardComponent({
  ...
  // 简化的URL处理逻辑
  let validUrl = url;
  if (!validUrl || typeof validUrl !== 'string' || validUrl.trim() === '') {
    validUrl = 'https://www.weather.gov';
  } else {
    ...
    >
      <div className="p-6">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800 font-medium text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 rounded cursor-pointer active:scale-95"
